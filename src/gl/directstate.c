...
AliasDecl(void,gl4es_glEnableClientStatei,(GLenum array, GLuint index),(array, index),gl4es_glEnableClientStateIndexed);
...
AliasDecl(void,gl4es_glDisableClientStatei,(GLenum array, GLuint index),(array, index),gl4es_glDisableClientStateIndexed);
